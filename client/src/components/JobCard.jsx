  ...
  return (
    <div className="p-4 bg-white dark:bg-gray-900 rounded-lg shadow-md relative">
      ...
      <p className="text-gray-700 dark:text-gray-300">
        URL: <a href={job.url.startsWith('http') ? job.url : `https://${job.url}`} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline break-words truncate">{job.url}</a>
      </p>
